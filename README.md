...
Specific projects can also be assigned to employees. The program follows the specified parameters exactly. Because both departments _switchgear manufacture_ and _kiln construction_ are preferred, some employees could sometimes become no project attributed. This situation can be averted by checking the box „AUTOMATIC FILL“, so that all remaining work projects are automatically distributed by orders of availabilities.
<br> <br> 
